...
/*
 * This class manages restaurant orders and menu items, including functionalities such as adding items to the menu, 
 * submitting and modifying orders, and ensuring deep copies of data to prevent external modifications. It includes methods for adding, changing,
 * and removing menu items and orders, as well as retrieving copies of the menu and orders to maintain data integrity within the system.
 */
