...
//order describes the properties of an order and has functions to calculate cost, get items, add items, etc
    ...
    public class Order
    {
        ...
        public ArrayList GetItems()
        {
            ...
            foreach (MenuItem item in items)
            {
                ...
                copy.MenuType = item.MenuType;
                copiedItems.Add(copy);
            }

            return copiedItems;
        }
        public List<MenuItem> GetItemsInList()
        {
            List<MenuItem> copiedItems = new List<MenuItem>();
        ...
        public bool Remove(MenuItem theItem)
        {
            ...
            for (int i = 0; i < items.Count; i++)
            {
                if (items[i].Description == theItem.Description &&
                    ...
                    items[i].MenuType == theItem.MenuType)
                {
                    items.RemoveAt(i);
                    return true;
                } 
